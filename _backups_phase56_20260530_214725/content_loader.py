...
REQUIRED_FIELDS = ["id", "type", "title_ar", "title_en", "tier",
                   "duration_seconds", "passage", "questions"]
...
def load_all(force_reload: bool = False) -> Dict[str, dict]:
    ...
    loaded_count = 0
    error_count = 0
    for subdir in ["academic", "daily", "complete_words"]:
