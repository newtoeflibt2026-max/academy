...
@home_bp.route("/mistakes")
def mistakes_page():
    uid = request.args.get("user_id", type=int) or 0
    return _placeholder(
        _ar(0x628,0x646,0x643,0x20,0x627,0x644,0x623,0x62E,0x637,0x627,0x621),
        _ar(0x633,0x62A,0x631,0x649,0x20,0x647,0x646,0x627,0x20,0x643,0x644,0x20,0x623,0x62E,0x637,0x627,0x626,0x643,0x20,0x645,0x639,0x20,0x634,0x631,0x62D,0x20,0x645,0x641,0x635,0x644,0x20,0x648,0x62A,0x645,0x627,0x631,0x64A,0x646,0x20,0x645,0x631,0x627,0x62C,0x639,0x629),
        uid)
...
def packages_page():
    uid = request.args.get("user_id", type=int) or 0
    return _placeholder(
        _ar(0x627,0x644,0x628,0x627,0x642,0x627,0x62A),
        _ar(0x627,0x62E,0x62A,0x631,0x20,0x627,0x644,0x628,0x627,0x642,0x629,0x20,0x627,0x644,0x645,0x646,0x627,0x633,0x628,0x629,0x20,0x644,0x644,0x648,0x635,0x648,0x644,0x20,0x644,0x647,0x62F,0x641,0x643),
        uid)
